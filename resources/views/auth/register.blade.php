<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex justify-between">
           ...
           برگشت <i data-feather="chevron-left" class="text-xl"></i></a>
        </div>
    </x-slot>
    ...
    <form method="POST" action="{{ route('register') }}" class="max-w-xl mx-auto">
        ...
        <!-- Password -->
        <div class="mt-4">
            <x-input-label for="password" :value="__('زمز - پسورد')" />
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <x-input-label for="password_confirmation" :value="__('تائید رمز')" />
