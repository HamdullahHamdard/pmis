            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flex justify-between px-4 sm:px-6 py-4 sm:py-8">
                    <div class="text-gray-900 dark:text-gray-100 text-2xl">
                        {{ __("واحد های پولی موجود در سیستم") }}
                    </div>
                    @can('create-currencies')
                        <a data-popover-target="create-popover" href={{url('stock/currency/create')}} type="button" class="text-gray-100 bg-green-600 hover:bg-green-700 p-3 flex justify-center items-center rounded-md text-center">
                            <i data-feather="plus"></i>
                        </a>
                        <div data-popover id="create-popover" role="tooltip" class="absolute z-10 invisible inline-block w-36 text-lg text-white transition-opacity duration-300 bg-green-600 rounded-lg shadow-sm text-center">
                            <div class="px-3 py-2">
                                <p>واحد پولی جدید</p>
                            </div>
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 text-md">
                                ...
                                <td class="py-4 flex justify-end">
                                    @can('edit-currencies')
                                        <a data-popover-target="edit-popover" href="{{ url('stock/currency/edit/'.$currency->id) }}" class="font-medium text-gray-200 bg-blue-600  flex items-center justify-center rounded-md p-2 text-center mr-2 hover:bg-blue-700">
                                    ...
                                    @can('delete-currencies')
                                        <a data-popover-target="delete-popover" onclick="return confirm('Are you sure to delete this record?')" href="{{ url('stock/currency/delete/'.$currency->id) }}" class="text-gray-200 bg-red-500 p-2 flex items-center justify-center rounded-md text-center mr-2 hover:bg-red-600">
