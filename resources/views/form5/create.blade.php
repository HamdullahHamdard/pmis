    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="p-6 overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                ...
                <form method="POST" class="mx-auto max-w-7xl" action="{{ route('form5s.store') }}"
                    ...
                    <div class="flex justify-between w-full mt-4">
                        ...
                        <div class="grid items-center grid-cols-4 gap-3">
                            ...
                            <x-text-input id="form9_id" class="block w-full col-span-3 mt-1" type="number" name="form9_id" :value="old('form9_id')" required autofocus autocomplete="form9_id" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="warehouse" class="block w-full mt-1" type="text" name="warehouse" required autofocus autocomplete="warehouse" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-area id="details" class="block w-full mt-1" type="text"
                                name="details" :value="old('details')" required autofocus
