    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="p-6 overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                ...
                <form method="POST" class="mx-auto max-w-7xl" action="{{ url('/formSubmission/store/'.$id) }}"
                    ...
                    <div class="mt-3">
                        ...
                        <x-input-label for="formNumber" :value="__('مقدار جنس')"
                            class="col-span-1 gap-2 text-lg text-gray-800" />
                            <x-text-input id="quantity" class="block w-full"
                            type="number" name="quantity" :value="old('quantity')" required autofocus
