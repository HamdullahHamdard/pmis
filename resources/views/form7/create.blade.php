<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <a href={{ route('form7') }} class="text-gray-600 flex dark:text-gray-300 hover:text-gray-800 dark:hover:text-white">
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <div>
                    <h1 class="text-center text-xl sm:text-2xl font-medium text-gray-800 dark:text-white">راپـــور رسـیـدات</h1>
                </div>
                <form method="POST" class="w-full mx-auto" action="{{ url('forms/form7/store') }}" enctype='multipart/form-data'
                    id="app-form">
                    @csrf
                    ...
                    <div class="mt-6 flex justify-center border-b border-gray-100 dark:border-gray-700">
                        <button data-modal-target="form7-modal" data-modal-toggle="form7-modal" type="button" class="text-gray-600 hover:text-black dark:text-gray-300 dark:hover:text-white font-medium p-3 rounded-md text-center">
                            <i data-feather="plus" class="w-8 h-8"></i>
                        </button>
                    </div>

                    <!-- Main modal -->
                    <div id="form7-modal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                        <div class="relative w-full max-w-xl max-h-full">
                            <!-- Modal content -->
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                                <button type="button" class="absolute top-3 left-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="form7-modal">
                                ...
                                <div class="px-6 py-6 lg:px-8">
                                    <h3 class="mb-6 text-xl font-medium text-gray-900 dark:text-white">اضافه کردن جنس رسید شده</h3>
