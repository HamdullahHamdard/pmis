            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="sm:grid sm:grid-cols-6 justify-between px-4 sm:px-6 py-4 sm:py-8 gap-10 space-y-4 sm:space-y-0">
                    ...
                    <div class="col-span-2">
                        <form action="{{ route('users', request()->query()) }}">
                    ...
                    <div class="col-span-2 flex justify-end">
                        @can('create-users')
                            <a data-popover-target="create-popover" href={{url('users/create')}} type="button" class="text-gray-100 bg-green-600 hover:bg-green-700 px-4 py-2 flex justify-center items-center rounded-md text-center">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 text-md">
                                ...
                                <td class="py-4 flex justify-end">
                                    @can('edit-users')
                                        <a data-popover-target="edit-popover" href="{{ url('users/edit/'.$user->id) }}" class="font-medium text-gray-200 bg-blue-600  flex items-center justify-center rounded-md p-2 text-center mr-2 hover:bg-blue-700">
                                    ...
                                    @can('delete-users')
                                        <a data-popover-target="delete-popover" onclick="return confirm('Are you sure to delete this record?')" href="{{ url('users/delete/'.$user->id) }}" class="text-gray-200 bg-red-500 p-2 flex items-center justify-center rounded-md text-center mr-2 hover:bg-red-600">
